<?php include("includes/dashboard_header.php"); ?>
		...
		?>
          ...
          <div class="d-flex align-items-center justify-content-between mb-4">
            <h1 class="h3 mb-0 text-gray-800">No Test Users</h1>
          </div>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="d-flex align-items-center justify-content-between card-header py-3">
              <h6 class="m-0 font-weight-bold text-primary">No Test User List</h6>
            </div>
            <div class="card-body">
              <form class="table-responsive" action="taken" method="post">
                <table class="table table-bordered" id="RateTable" width="100%" cellspacing="0">
                  ...
                  <tbody>
                  	<?php
                  		$userq = $conex->query("SELECT * FROM users WHERE STATUS = 1");
                  	...
                  	?>
                  		<tr>
                  			...
                  			<td><a href="no-test?view=<?=($data['CODE']);?>">View</a></td>
                  		</tr>
                  	<?php
                  		}
                  	?>
